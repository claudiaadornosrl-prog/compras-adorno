  ...
  return [
    ...
    },
    {
      ...
      pasos: [
        ...
        'Renglones editables (24-sep): en la tabla de la factura cada renglón muestra Cant · Descripción/SKU · P. unit · Dto · P. unit con descuento · Neto · Control · Concepto. Cantidad, precio unitario y descuento se pueden corregir ahí mismo: el neto y el control contra la lista del Dragonfish se recalculan al tipear, y se guardan al contabilizar (queda registrado qué había antes). Si cambia una cantidad, el remito de esa factura que todavía no se importó se actualiza solo. Debajo, en «Descuentos generales», se agregan los descuentos que no son por producto (ej. 5 % por pago contado): con % se calcula sobre la suma de renglones, o se pone un importe fijo. «Dto a todos los renglones» aplica el mismo % a todos de una vez. El pie compara renglones − descuentos generales contra el neto de la factura y avisa si no cierra.',
        ...
        '✂ Reparto (24-sep): un gasto puede ir parte a un local y parte a otro, o a varios meses, en las proporciones que sean. En el recuadro de la planilla hay un renglón con Período, Unidad, Categoría e Importe; «+ Agregar renglón» suma otro (arranca con lo que falta repartir) y en cada uno ponés el importe que corresponde. Abajo avisa si los renglones no suman el «Total a la planilla». En la planilla de Gastos cada renglón aparece en su mes y su local, marcado «✂ parte 1 de 3».',
