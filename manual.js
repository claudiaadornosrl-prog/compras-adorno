  ...
  return [
    ...
    },
    {
      ...
      pasos: [
        ...
        '💳 Medios de pago: por defecto hay uno con el neto completo. Si la OP se paga en partes (parte por transferencia, parte con cheque, parte en efectivo), "➕ Otro medio de pago" agrega filas: cada una con su medio, su importe y, si querés, la cuenta de Tesorería. Con "cheque" aparecen número, banco y fecha de pago. La suma tiene que dar el neto a pagar: el sistema muestra cuánto falta asignar y no emite si no cierra.',
